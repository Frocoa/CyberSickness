namespace EmotivUnityPlugin
{
    ...
    public static class Config
    {
        ...
        public static string AppClientId            = "0UQKT5NxAan9hitzZQCuMzww9eAuofYwjmoNiPKS";
        public static string AppClientSecret        = "sKOuFqZXuli8CtARWZjDHxK5bpLPWU7n7UMFbIqJARqSQs8inASpAligUJBJdosAxReT5sHqutoVrqGF6tNUXLtWsiCJwVMhCCEhYiFl9wZyrHjGxhfaDhG8GV7wh5wY";

         public static string AppUrl                 = "wss://localhost:6868"; // default
        public static string AppVersion             = "3.3.0"; // default
        public static string AppName = "test-unity";
